...
/// Composite catalog list (`GET /item/?is_composite=true`).
class CompositeItemPage extends ConsumerStatefulWidget {
  const CompositeItemPage({super.key});

  @override
  ConsumerState<CompositeItemPage> createState() => _CompositeItemPageState();
}
  ...
  Widget _itemRow(ItemModel item) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: id.isEmpty
            ? null
            : () => context.push(CompositeItemDetailsPage.pathFor(id)),
        child: Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Composite bundles from your catalog will appear here',
              textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: 'composite_items_add_fab',
        onPressed: () async {
          final created = await context.push<ItemModel>(AddCompositeItemPage.path);
          if (!mounted) return;
          if (created != null) {
